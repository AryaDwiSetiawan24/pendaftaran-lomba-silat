            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Nama, NIK, No. Telepon..."
                ...
                <div class="border-b border-gray-200 p-4 hover:bg-gray-50 transition">
                    ...
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex items-center gap-3 flex-1 min-w-0">
                            <div
                                class="h-12 w-12 bg-red-900 text-white rounded-full flex items-center justify-center font-semibold flex-shrink-0">
                                {{ strtoupper(substr($p->full_name, 0, 2)) }}
                            </div>
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-gray-900 truncate">{{ $p->full_name }}</p>
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-gray-200">
                        ...
                        <div class="flex gap-2">
                            @if ($p->validation_status == 'pending')
                                <form action="{{ route('admin.peserta.approve', $p->id) }}" method="POST"
                                    ...
                                    <button class="p-2 text-green-600 hover:bg-green-50 rounded-lg transition"
                                        title="Setujui">
                                        <i class="uil uil-check text-xl"></i>
                                    </button>
                                </form>
                                <form action="{{ route('admin.peserta.reject', $p->id) }}" method="POST"
                                    onsubmit="return confirm('Tolak peserta ini?')">
                            ...
                            <a href="{{ route('admin.peserta.edit', $p->id) }}"
                                class="p-2 text-yellow-600 hover:bg-yellow-50 rounded-lg transition" title="Lihat">
