    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center">
                ...
                <div class="h-8 w-8 mt-2 text-yellow-400"><svg xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <div class="flex items-center space-x-4">
                <div class="h-6 w-6 cursor-pointer hover:text-yellow-400"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="flex items-center space-x-2">
                    <div
                        class="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center text-red-900 font-bold">
                        {{ strtoupper(substr(Auth::user()->name ?? 'Admin test', 0, 1)) }}</div>
                    <span>{{ Auth::user()->name ?? 'Admin test' }}</span>
                </div>
                <a href="/logout" data-view="landing"
                    class="nav-btn flex items-center hover:text-yellow-400">
                    <span class="h-5 w-5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
