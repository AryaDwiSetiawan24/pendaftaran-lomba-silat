    ...
    <div class="relative w-64 h-full bg-white overflow-y-auto">
        <div class="p-6 space-y-2">
            ...
            <a href="{{ route('admin.add-lomba') }}"
                class="w-full flex items-center px-4 py-3 rounded-lg text-sm 
                {{ request()->routeIs('admin.add-lomba') ? 'bg-red-800 hover:bg-red-700 text-white' : 'text-gray-700 hover:bg-gray-200' }}">
...
<div class="fixed hidden md:block w-64 bg-white h-screen shadow-lg">
    <div class="p-4 space-y-2">
        ...
        <a href="{{ route('admin.lomba') }}"
            class="w-full flex items-center px-4 py-3 rounded-lg
            {{ request()->routeIs('admin.lomba') || request()->routeIs('admin.add-lomba') ? 'bg-red-800 hover:bg-red-700 text-white' : 'text-gray-700 hover:bg-gray-200' }}">
        ...
        <a href="{{ route('admin.jadwal.index') }}"
            class="w-full flex items-center px-4 py-3 rounded-lg
            {{ request()->routeIs('jadwal.index') ? 'bg-red-800 hover:bg-red-700 text-white' : 'text-gray-700 hover:bg-gray-200' }}">
